...
media_ra = st.number_input('Insira o Valor da Média Rápida', min_value=0, step=int)
media_le = st.number_input('Insira o Valor da Média Lenta', max_value=100, step=int)
