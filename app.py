...
media_ra = st.number_input('Insira o Valor da Média Rápida', min_value=0, max_value=100)
media_le = st.number_input('Insira o Valor da Média Lenta', min_value=0, max_value=100)
